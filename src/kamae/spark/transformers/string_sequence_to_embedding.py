...
from kamae.keras.tensorflow.layers import StringSequenceToEmbeddingLayer
...
class StringSequenceToEmbeddingTransformer(
    ...
    def __init__(
        ...
        transforming.
        :param layerName: Name of the layer. Used as the name of the Keras
    ...
    def get_keras_layer(self) -> tf.keras.layers.Layer:
        """
        Gets the Keras layer for the StringSequenceToEmbedding transformer.

        :returns: Keras layer equivalent to this transformer.
        """
