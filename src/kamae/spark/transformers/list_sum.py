...
class ListSumTransformer(
    ...
    """
    Calculate the listwise sum across the query id column.
    ...
    def get_keras_layer(self) -> tf.keras.layers.Layer:
        """
        Gets the Keras layer for the listwise-sum transformer.

        :returns: Keras layer with name equal to the layerName parameter that
         performs a summing operation.
        """
        return ListSumLayer(
