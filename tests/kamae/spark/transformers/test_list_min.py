...
from kamae.spark.transformers import ListMinTransformer
...
class TestListMin:
    ...
    def test_spark_min_transform(
        ...
        # when
        transformer = ListMinTransformer(
            inputCol=value_col,
    ...
    def test_spark_min_transform_with_sort(
        self,
        input_dataframe,
        value_col,
        sort_col,
    ...
    def test_spark_min_transform_with_segmentation(
        self,
        input_dataframe,
        value_col,
        segment_col,
