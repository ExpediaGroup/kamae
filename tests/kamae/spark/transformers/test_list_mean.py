...
from kamae.spark.transformers import ListMeanTransformer
...
class TestListMean:
    ...
    def listwise_transform_df_sort_desc(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 1, 1, 4.0),  # should be ignored in top3 desc
                (1, 2, 2, 4.0),
                (1, 2, 3, 4.0),
                (1, 8, 4, 4.0),
            ],
    ...
    def listwise_transform_df_sort_asc(self, spark_session):
        return spark_session.createDataFrame(
            [
                ...
                (1, 2, 2, 3.0),
                (1, 2, 3, 3.0),
                (1, 8, 4, 3.0),  # should be ignored in top3 asc
            ],
            [
                "search_id",
                "value_col",
    ...
    def test_spark_mean_transform_with_sort(
        self,
        input_dataframe,
        value_col,
        sort_col,
    ...
    def test_list_mean_transform_spark_tf_parity(
        self,
        spark_session,
        list_size,
        qid_tensor,
