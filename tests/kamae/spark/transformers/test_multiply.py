...
from kamae.spark.transformers import MultiplyTransformer
...
class TestMultiply:
    ...
    def multiply_transform_expected_1(self, spark_session):
        return spark_session.createDataFrame(
            ...
            [
                ...
                "col5",
                "col1_col2_col3",
                "multiply_col1_w_constant",
            ],
        )

    @pytest.fixture(scope="class")
    def multiply_transform_expected_2(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 2, 3, "a", "c", [1, 2, 3], 6),
                (4, 2, 6, "b", "c", [4, 2, 6], 48),
            ...
            [
                ...
                "col5",
                "col1_col2_col3",
                "multiply_col1_col2_col3",
            ],
        )

    @pytest.fixture(scope="class")
    def multiply_transform_expected_3(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 2, 3, "a", "c", [1, 2, 3], 3),
                (4, 2, 6, "b", "c", [4, 2, 6], 24),
    ...
    @pytest.fixture(scope="class")
    def multiply_transform_expected_4(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 2, 3, "a", "c", [1, 2, 3], -24),
                (4, 2, 6, "b", "c", [4, 2, 6], -24),
            ...
            [
                ...
                "col5",
                "col1_col2_col3",
                "multiply_col2_w_constant",
            ],
        )

    @pytest.fixture(scope="class")
    def multiply_transform_array_col1(self, spark_session):
        return spark_session.createDataFrame(
            [
                (
                    [
            ...
            ["col1", "col2", "multiply_col1_w_constant"],
        )

    @pytest.fixture(scope="class")
    def multiply_transform_array_col1_col2(self, spark_session):
        return spark_session.createDataFrame(
            [
                (
                    [
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                None,
                "multiply_col1_col2",
                "multiply_transform_array_col1_col2",
            ),
        ],
    )
    def test_spark_multiply_transform(
        self,
        input_dataframe,
        input_col,
        input_cols,
    ...
    def test_multiply_transform_defaults(self):
        # when
        multiply_transformer = MultiplyTransformer()
        # then
        assert multiply_transformer.getLayerName() == multiply_transformer.uid
        assert (
            multiply_transformer.getOutputCol() == f"{multiply_transformer.uid}__output"
        )
    ...
    def test_multiply_transform_single_input_spark_tf_parity(
    ...
    def test_multiply_transform_multiple_input_spark_tf_parity(
