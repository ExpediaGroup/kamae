...
from kamae.spark.transformers import SumTransformer
...
class TestSum:
    ...
    def sum_transform_expected_1(self, spark_session):
    ...
    @pytest.fixture(scope="class")
    def sum_transform_expected_2(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 2, 3, "a", "c", [1, 2, 3], 6),
                (4, 2, 6, "b", "c", [4, 2, 6], 12),
    ...
    @pytest.fixture(scope="class")
    def sum_transform_expected_3(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 2, 3, "a", "c", [1, 2, 3], 4),
                (4, 2, 6, "b", "c", [4, 2, 6], 10),
            ...
            ["col1", "col2", "col3", "col4", "col5", "col1_col2_col3", "sum_col1_col3"],
        )

    @pytest.fixture(scope="class")
    def sum_transform_expected_4(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 2, 3, "a", "c", [1, 2, 3], -10),
                (4, 2, 6, "b", "c", [4, 2, 6], -10),
    ...
    @pytest.fixture(scope="class")
    def sum_transform_array_col1(self, spark_session):
        return spark_session.createDataFrame(
            [
                (
                    [
            ...
            ["col1", "col2", "sum_col1_w_constant"],
        )

    @pytest.fixture(scope="class")
    def sum_transform_array_col1_col2(self, spark_session):
        return spark_session.createDataFrame(
            [
                (
                    [
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                None,
                "sum_col1_col2",
                "sum_transform_array_col1_col2",
            ),
        ],
    )
    def test_spark_sum_transform(
        self,
        input_dataframe,
        input_col,
        input_cols,
    ...
    def test_sum_transform_defaults(self):
        # when
        sum_transformer = SumTransformer()
        # then
        assert sum_transformer.getLayerName() == sum_transformer.uid
        assert sum_transformer.getOutputCol() == f"{sum_transformer.uid}__output"
    ...
    def test_sum_transform_single_input_spark_tf_parity(
    ...
    def test_sum_transform_multiple_input_spark_tf_parity(
