...
from kamae.spark.transformers import MaxTransformer
...
class TestMax:
    ...
    def max_transform_expected_1(self, spark_session):
    ...
    @pytest.fixture(scope="class")
    def max_transform_expected_2(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 2, 3, "a", "c", [1, 2, 3], 3),
                (4, 2, 6, "b", "c", [4, 2, 6], 6),
    ...
    @pytest.fixture(scope="class")
    def max_transform_expected_3(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 2, 3, "a", "c", [1, 2, 3], 3),
                (4, 2, 6, "b", "c", [4, 2, 6], 6),
            ...
            ["col1", "col2", "col3", "col4", "col5", "col1_col2_col3", "max_col1_col3"],
        )

    @pytest.fixture(scope="class")
    def max_transform_expected_4(self, spark_session):
        return spark_session.createDataFrame(
            [
                (1, 2, 3, "a", "c", [1, 2, 3], 6),
                (4, 2, 6, "b", "c", [4, 2, 6], 6),
    ...
    @pytest.fixture(scope="class")
    def max_transform_array_col1(self, spark_session):
        return spark_session.createDataFrame(
            [
                (
                    [
            ...
            ["col1", "col2", "max_col1_w_constant"],
        )

    @pytest.fixture(scope="class")
    def max_transform_array_col1_col2(self, spark_session):
        return spark_session.createDataFrame(
            [
                (
                    [
    ...
    def test_max_transform_defaults(self):
        # when
        max_transformer = MaxTransformer()
        # then
        assert max_transformer.getLayerName() == max_transformer.uid
        assert max_transformer.getOutputCol() == f"{max_transformer.uid}__output"
    ...
    def test_max_transform_single_input_spark_tf_parity(
    ...
    def test_max_transform_multiple_input_spark_tf_parity(
