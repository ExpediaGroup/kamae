...
class TestMax:
    @pytest.mark.parametrize(
        "inputs, input_name, max_constant, input_dtype, output_dtype, expected_output",
        [
            (
            ...
            (
                ...
                "float64",
                None,
                tf.constant([[[3.0, 3.0, 30.0]]], dtype="float64"),
            ),
            (
                [
    ...
    @pytest.mark.parametrize(
        "inputs, input_name, max_constant",
        [
            (
    ...
    def test_max_raises_error(self, inputs, input_name, max_constant):
        with pytest.raises(ValueError):
            layer = MaxLayer(name=input_name, max_constant=max_constant)
            layer(inputs)
    ...
    def test_max_with_bad_types_raises_error(
