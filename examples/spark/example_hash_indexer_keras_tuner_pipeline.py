...
if __name__ == "__main__":
    ...
    tf_input_schema = [
        tf.TensorSpec(name="col1", dtype=tf.string, shape=(None, 1)),
        tf.TensorSpec(name="col2", dtype=tf.string, shape=(None, 1)),
        tf.TensorSpec(name="col3", dtype=tf.string, shape=(None, 1)),
    ]
    ...
    best_model.save("output/test_keras_tuner_hash_best_model")

    print("Loading best model")
    loaded_best_model = tf.keras.models.load_model(
        "output/test_keras_tuner_hash_best_model"
    )
