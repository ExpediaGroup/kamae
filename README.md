...
|           SegmentMax            |                                                         Computes the maximum value of a feature, segmented by another.                                                          |         [Link](src/kamae/tensorflow/layers/segment_max.py)         |         [Link](src/kamae/spark/transformers/segment_max.py)          |                     Not yet implemented                     |
|           SegmentMean           |                                                           Computes the mean value of a feature, segmented by another.                                                           |        [Link](src/kamae/tensorflow/layers/segment_mean.py)         |         [Link](src/kamae/spark/transformers/segment_mean.py)          |                     Not yet implemented                     |
|           SegmentMin            |                                                         Computes the minimum value of a feature, segmented by another.                                                          |         [Link](src/kamae/tensorflow/layers/segment_min.py)         |         [Link](src/kamae/spark/transformers/segment_min.py)          |                     Not yet implemented                     |
